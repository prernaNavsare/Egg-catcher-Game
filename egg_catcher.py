...
background = pygame.image.load(r'D:\Python Project\egg_catcher\images\bgimage.jpeg')
pygame.display.set_caption('Egg Catcher')

# bg sound
mixer.music.load(r'D:\Python Project\egg_catcher\hot-cup-of-egg-nog-winter-celebration-piano-instrumental-orchestral-145266.mp3')
mixer.music.play(-1)

# player
playerImg = pygame.image.load(r'D:\Python Project\egg_catcher\images\basket.png')
playerx = 100 
playery = 380
playery_change = 0
playerx_change = 0
...
# eggs
crackImg = pygame.image.load(r'D:\Python Project\egg_catcher\images\yellow crack.png')
crackImg1 = pygame.image.load(r'D:\Python Project\egg_catcher\images\white crack.png')
crackImg2 = pygame.image.load(r'D:\Python Project\egg_catcher\images\black crack.png')

eggImg = [
    pygame.image.load(r'D:\Python Project\egg_catcher\images\yellow egg.png'),
    pygame.image.load(r'D:\Python Project\egg_catcher\images\white egg.png'),
    pygame.image.load(r'D:\Python Project\egg_catcher\images\yellow egg.png'),
    pygame.image.load(r'D:\Python Project\egg_catcher\images\black egg.png')      
]
...
# Add the golden egg at a random position
golden_egg_x = random.randint(0, 570)
golden_egg_y = random.randint(0, 100)
...
# timer
sec = 30 #--- for easy lavel
#sec = 20 #--- for Hard lavel
...
def showlevel():
    ...
    score_value = font.render('            Easy', True, (0, 255, 0)) #---for easy lavel
    #score_value = font.render('            Hard', True, (0, 255, 0)) #--- for hard lavel
    screen.blit(score_value, (700, 60))
    score_value = font.render('Target : 30', True, (255, 255, 255)) #---for easy level
    #score_value = font.render('Target : 20', True, (255, 255, 255))  #---for hard lavel
...
pause = False
Exit = False
target = 30 #--- for easy level 
#target = 20 #--- for hard lavel
...
# After this loop, handle game state checks (like game over or victory conditions)
    

    # Add your existing collision checks here...
  # check when to display cracked eggs
    ...
    if not pause:
        sec -= 1 / 36  # 72 iterations per second
    ...
    pygame.time.Clock().tick(15) #-- for easy level
    #pygame.time.Clock().tick(20) #--- for hard level
